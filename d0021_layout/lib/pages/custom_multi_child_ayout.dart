...
class CustomMultiChildLayoutLayoutDemo extends StatelessWidget {
  const CustomMultiChildLayoutLayoutDemo({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const CustomMultiChildLayoutExampleWidget(),
    );
  }
}
...
class CustomMultiChildLayoutExampleWidget extends StatelessWidget {
  const CustomMultiChildLayoutExampleWidget({super.key});
