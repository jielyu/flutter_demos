...
class SpecialBottomBar extends StatefulWidget {
  final BuildContext menuScreenContext;
  const SpecialBottomBar({Key? key, required this.menuScreenContext})
      : super(key: key);

  @override
  _SpecialBottomBarState createState() => _SpecialBottomBarState();
}

class _SpecialBottomBarState extends State<SpecialBottomBar> {
  late PersistentTabController _controller;
  late bool _hideNavBar;
  int _styleIdx = 1;
  NavBarStyle _navStyle = NavBarStyle.values[17];
  late Timer _timer;
  static final List<int> _styleIdxArray = [14, 17];
  ...
  List<PersistentBottomNavBarItem> _buildNavBars() {
    return <PersistentBottomNavBarItem>[
      ...
      PersistentBottomNavBarItem(icon: const Icon(Icons.edit)),
